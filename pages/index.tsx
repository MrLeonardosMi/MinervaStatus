...
const Home: NextPage = () => {
  return (
    <div className='h-full w-full '>
      ...
      <div className="w-full h-40 absolute bg-light-purple dark:purple dark:bg-gray-900">
        <div className="sm:ml-0 ml-5 mr-0 mt-3 md:pl-80 md:pr-80 sm:w-full h-full bg-purple-500 dark:bg-gray-900">
